    ...
    renderEvents: function(events) {
            ...
            for (i in displayeventlist) {
                ...
                if ( evMonth == visMonth && evYear == visYear) {
                    ...
                    startDate       = htmlEscape(formatDate(displayeventlist[i].start, this.opt('columnFormat')));
                    if ( displayeventlist[i].end ) {
                        endDate         = htmlEscape(formatDate(displayeventlist[i].end, this.opt('columnFormat')));
                    }
